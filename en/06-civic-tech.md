...
[Parti Civic Tech](https://data.campaigns.do){: .btn .btn-outline .fs-3 }
...
[Parti Citizen Policy DB](https://data.campaigns.do/datasets/EzqHyg){: .btn .btn-outline .fs-3 }
...
[Code for Korea](https://codefor.kr){: .btn .btn-outline .fs-3 }
...
[Parti Citizen Datasets](https://data.campaigns.do/datasets){: .btn .btn-outline .fs-3 }
