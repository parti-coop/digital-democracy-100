...
수천에서 수만 건의 시민 의견을 AI로 분류·요약·분야별 패턴 추출해, 시민이 직접 의제를 발굴할 수 있게 하는 기능. 모두의 국민통합 플랫폼, 천만의 연결 등에서 이미 작동하고 있습니다. AI가 판정을 내리는 것이 아니라 시민의 숙의를 돕는 방향. (5번 거버넌스 카테고리에서 자세히 다루며, 이 기능의 한계와 경계는 17번 항목에서 다룹니다.)
