...
시민이 함께 이슈 관련 뉴스를 찾아 '이슈 타임라인'으로 엮고 대화를 나누는 90분짜리 워크숍. '에디터'와 '마라톤'을 합친 말로, 정해진 시간 동안 집중해서 콘텐츠를 편집하고 정리합니다. 발제나 읽을거리를 함께 읽고, 키워드를 나누고, 각자 찾은 뉴스를 코멘트와 함께 타임라인에 올린 뒤 대화하는 흐름. 참가자가 직접 뉴스 출처를 찾아 올리게 해 정보의 다양성을 확보하는 것이 설계의 핵심입니다. 새로운 의제로 모임을 시작할 때 라포를 만드는 입구 역할을 하며, 이후 시민대화·데이터톤·캠페인으로 이어집니다. 2025년 2월 온라인으로 연 '#개헌 뉴스 에디터톤', 국시모와 함께한 '천연기념물 산양, 함께살기' 등이 있습니다.

[뉴스 에디터톤 툴킷](https://campaigns.do/toolkits/news-editathon){: .btn .btn-outline .fs-3 }
...
빠띠가 10년간 운영하며 쌓은 방법론을 누구나 그대로 따라 할 수 있는 형태로 공개한 툴킷 모음. 공론장과 토론, 시민 캠페인, 팩트체크, 거버넌스와 시민의회, 시민 기술, 커뮤니티 여섯 갈래에 37개의 툴킷이 추진 배경, 핵심 개념, 진행 프로세스, 거버넌스 원칙, 운영 사례, 기대 효과까지 정리되어 있습니다. 빠띠가 직접 운영하지 않아도 다른 조직과 시민이 스스로 광장을 열 수 있게 하는 것이 목적. 이 문서에 기록된 프로그램 상당수가 툴킷으로 공개되어 있습니다.

[빠띠 시민 활동 툴킷](https://campaigns.do/toolkits){: .btn .btn-outline .fs-3 }
